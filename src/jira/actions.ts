import {
  ...
  export interface SyncJiraOpenRepo {
    repo: string
    owner: string
    label: string
    projectKey: string
  ...
  export interface SyncJiraOpenOrg {
    org: string
    label: string
    projectKey: string
    issueType: string
  ...
  export interface SyncJiraOpenEnterprise {
    enterprise: string
    label: string
    projectKey: string
    issueType: string
  ...
  export interface SyncJiraOpenAlertNumber {
    alertNumber: string
    label: string
    projectKey: string
    issueType: string
  ...
  export async function syncJiraWithOpenDependabotPullsRepo(
    params: SyncJiraOpenRepo
  ): Promise<string> {
    try {
      core.setOutput(
        'Sync jira with open dependabot pulls from a repository, is starting',
